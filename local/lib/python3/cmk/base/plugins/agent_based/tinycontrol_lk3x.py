...
OIDs = [
#	["oid","param_name","param description", do_Matric],
	["2.1", "inpd1", "Digital Input 1", False],
	["2.2", "inpd2", "Digital Input 2", False],
	["2.3", "inpd3", "Digital Input 3", False],
	["2.4", "inpd4", "Digital Input 4", False],
	["3.1", "inpa1", "Analog Input 1", False],
	["3.2", "inpa2", "Analog Input 2", False],
	["3.3", "inpa3", "Analog Input 3", False],
	["3.4", "inpa4", "Analog Input 4", False],
	["3.5", "inpa5", "Analog Input 5", False],
	["3.6", "inpa6", "Analog Input 6", False],
	["3.7", "vcc", "Voltage", True],
	["3.8", "temp", "Temperature", True],
	["4.1", "ds1", "DS 1", False],
	["4.2", "ds1", "DS 2", False],
	["4.3", "ds1", "DS 3", False],
	["4.4", "ds1", "DS 4", False],
	...
	["4.9", "t1", "T1", False],
	["4.10","h1", "H1", False],
	["4.11","diff1", "Diff 1", False],
	["4.12","diff2", "Diff 2", False],
	["4.13","diff3", "Diff 3", False],
	["4.14","p1", "P1", False],
	["4.15","co2", "CO2", False],
	["4.16","pm1", "PM 1", False],
	["4.17","pm2", "PM 2", False],
	["4.18","pm4", "PM 4", False],
	["4.19","pm10", "PM 10", False],
	["5.1", "power1", "Power 1", False],
	["5.2", "power2", "Power 2", False],
	["5.3", "power3", "Power 3", False],
	["5.4", "power4", "Power 4", False],
	["5.5", "energy1", "Energy 1", False],
	["5.6", "energy2", "Energy 2", False],
	["5.7", "energy3", "Energy 3", False],
	["5.8", "energy4", "Energy 4", False],
	["6.1", "m1", "Modbus 1", False],
	["6.2", "m2", "Modbus 2", False],
	["6.3", "m3", "Modbus 3", False],
	["6.4", "m4", "Modbus 4", False],
	["6.5", "m5", "Modbus 5", False],
	["6.6", "m6", "Modbus 6", False],
	["6.7", "m7", "Modbus 7", False],
	["6.8", "m8", "Modbus 8", False],
	["6.9", "m9", "Modbus 9", False],
        ["6.10", "m10", "Modbus 10", False],
        ["6.11", "m11", "Modbus 11", False],
        ["6.12", "m12", "Modbus 12", False],
        ["6.13", "m13", "Modbus 13", False],
        ["6.14", "m14", "Modbus 14", False],
        ["6.15", "m15", "Modbus 15", False],
        ["6.16", "m16", "Modbus 16", False],
        ["6.17", "m17", "Modbus 17", False],
        ["6.18", "m18", "Modbus 18", False],
        ["6.19", "m19", "Modbus 19", False],
        ["6.20", "m20", "Modbus 20", False],
        ["6.21", "m21", "Modbus 21", False],
        ["6.22", "m22", "Modbus 22", False],
        ["6.23", "m23", "Modbus 23", False],
        ["6.24", "m24", "Modbus 24", False],
        ["6.25", "m25", "Modbus 25", False],
        ["6.26", "m26", "Modbus 26", False],
        ["6.27", "m27", "Modbus 27", False],
        ["6.28", "m28", "Modbus 28", False],
        ["6.29", "m29", "Modbus 29", False],
        ["6.30", "m30", "Modbus 30", False],
]
